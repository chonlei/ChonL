...
public:
    ...
    const double * IndexTable0(double var_chaste_interface__Membrane__Vm)
    {
        ...
        const double* const _lt_0_row = Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
    ...
    void RegenerateTables()
    {
        ...
        if (mNeedsRegeneration[0])
        {
            ...
            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                ...
                _lookup_table_0[i][0] = 1.0 / pow(1.0 + exp((((-(0.001 * var_chaste_interface__Membrane__Vm)) * 1000.0) - 34.100000000000001) * 0.16949152542372881), 0.33333333333333331);
            }
            
            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__Membrane__Vm = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][1] = (1.0 * ((1.0 / (1.0 + exp((((-(0.001 * var_chaste_interface__Membrane__Vm)) * 1000.0) - 60.0) * 0.20000000000000001))) * ((0.10000000000000001 / (1.0 + exp((((0.001 * var_chaste_interface__Membrane__Vm) * 1000.0) + 35.0) * 0.20000000000000001))) + (0.10000000000000001 / (1.0 + exp((((0.001 * var_chaste_interface__Membrane__Vm) * 1000.0) - 50.0) * 0.0050000000000000001)))))) * 0.001;
            }
            
            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__Membrane__Vm = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][2] = 1.0 / sqrt(1.0 + exp((((0.001 * var_chaste_interface__Membrane__Vm) * 1000.0) + 72.099999999999994) * 0.17543859649122806));
            }
            
            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__Membrane__Vm = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][3] = ((0.001 * var_chaste_interface__Membrane__Vm) <  -0.040000000000000001) ? (1.5 / (((((0.001 * var_chaste_interface__Membrane__Vm) <  -0.040000000000000001) ? (0.057000000000000002 * exp((-(((0.001 * var_chaste_interface__Membrane__Vm) * 1000.0) + 80.0)) * 0.14705882352941177)) : 0.0) + (((0.001 * var_chaste_interface__Membrane__Vm) <  -0.040000000000000001) ? ((2.7000000000000002 * exp(0.079000000000000001 * ((0.001 * var_chaste_interface__Membrane__Vm) * 1000.0))) + (3.1000000000000001 * (100000.0 * exp(0.34849999999999998 * ((0.001 * var_chaste_interface__Membrane__Vm) * 1000.0))))) : (0.77000000000000002 / (0.13 * (1.0 + exp((((0.001 * var_chaste_interface__Membrane__Vm) * 1000.0) + 10.66) *  -0.0900900900900901)))))) * 1000.0)) : 0.002542;
            }
            
            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__Membrane__Vm = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][4] = 1.0 / sqrt(1.0 + exp((((0.001 * var_chaste_interface__Membrane__Vm) * 1000.0) + 72.099999999999994) * 0.17543859649122806));
            }
            
            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__Membrane__Vm = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][5] = 7.0 / (((((0.001 * var_chaste_interface__Membrane__Vm) <  -0.040000000000000001) ? (((( -25428.0 * exp(0.24440000000000001 * ((0.001 * var_chaste_interface__Membrane__Vm) * 1000.0))) - (6.9480000000000004 * (9.9999999999999995e-07 * exp( -0.043909999999999998 * ((0.001 * var_chaste_interface__Membrane__Vm) * 1000.0))))) * (((0.001 * var_chaste_interface__Membrane__Vm) * 1000.0) + 37.780000000000001)) / (1.0 + exp(0.311 * (((0.001 * var_chaste_interface__Membrane__Vm) * 1000.0) + 79.230000000000004)))) : 0.0) + (((0.001 * var_chaste_interface__Membrane__Vm) <  -0.040000000000000001) ? ((0.024240000000000001 * exp( -0.01052 * ((0.001 * var_chaste_interface__Membrane__Vm) * 1000.0))) / (1.0 + exp( -0.13780000000000001 * (((0.001 * var_chaste_interface__Membrane__Vm) * 1000.0) + 40.140000000000001)))) : ((0.59999999999999998 * exp(0.057000000000000002 * ((0.001 * var_chaste_interface__Membrane__Vm) * 1000.0))) / (1.0 + exp( -0.10000000000000001 * (((0.001 * var_chaste_interface__Membrane__Vm) * 1000.0) + 32.0)))))) * 1000.0);
            }
            
            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__Membrane__Vm = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][6] = 1.0 / (1.0 + exp((-(((0.001 * var_chaste_interface__Membrane__Vm) * 1000.0) + 9.0999999999999996)) * 0.14285714285714285));
            }
            
            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__Membrane__Vm = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][7] = ((((0.25 + (1.3999999999999999 / (1.0 + exp((((-(0.001 * var_chaste_interface__Membrane__Vm)) * 1000.0) - 35.0) * 0.076923076923076927)))) * (1.3999999999999999 / (1.0 + exp((((0.001 * var_chaste_interface__Membrane__Vm) * 1000.0) + 5.0) * 0.20000000000000001)))) + (1.0 / (1.0 + exp((((-(0.001 * var_chaste_interface__Membrane__Vm)) * 1000.0) + 50.0) * 0.050000000000000003)))) * 1.0) * 0.001;
            }
            
            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__Membrane__Vm = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][8] = 1.0 / (1.0 + exp((((0.001 * var_chaste_interface__Membrane__Vm) * 1000.0) + 26.0) * 0.33333333333333331));
            }
            
            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__Membrane__Vm = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][9] = 20.0 + ((1102.5 * exp(-pow(pow(((0.001 * var_chaste_interface__Membrane__Vm) * 1000.0) + 27.0, 2.0) * 0.066666666666666666, 2.0))) + ((200.0 / (1.0 + exp((13.0 - ((0.001 * var_chaste_interface__Membrane__Vm) * 1000.0)) * 0.10000000000000001))) + (180.0 / (1.0 + exp((30.0 + ((0.001 * var_chaste_interface__Membrane__Vm) * 1000.0)) * 0.10000000000000001)))));
            }
            
            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__Membrane__Vm = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][10] = 1.0 / (1.0 + exp((((0.001 * var_chaste_interface__Membrane__Vm) * 1000.0) + 26.0) * 0.33333333333333331));
            }
            
            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__Membrane__Vm = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][11] = 0.33000000000000002 + (0.67000000000000004 / (1.0 + exp((((0.001 * var_chaste_interface__Membrane__Vm) * 1000.0) + 35.0) * 0.25)));
            }
            
            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__Membrane__Vm = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][12] = (((600.0 * exp((-pow(((0.001 * var_chaste_interface__Membrane__Vm) * 1000.0) + 25.0, 2.0)) * 0.0058823529411764705)) + ((31.0 / (1.0 + exp((25.0 - ((0.001 * var_chaste_interface__Membrane__Vm) * 1000.0)) * 0.10000000000000001))) + (16.0 / (1.0 + exp((30.0 + ((0.001 * var_chaste_interface__Membrane__Vm) * 1000.0)) * 0.10000000000000001))))) * 1.0) * 0.001;
            }
            
            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__Membrane__Vm = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][13] = (1.0 * ((450.0 / (1.0 + exp(( -45.0 - ((0.001 * var_chaste_interface__Membrane__Vm) * 1000.0)) * 0.10000000000000001))) * (6.0 / (1.0 + exp((30.0 + ((0.001 * var_chaste_interface__Membrane__Vm) * 1000.0)) * 0.086956521739130432))))) * 0.001;
            }
            
            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__Membrane__Vm = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][14] = 1.0 / (1.0 + exp((((0.001 * var_chaste_interface__Membrane__Vm) * 1000.0) + 88.0) * 0.02));
            }
            
            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__Membrane__Vm = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][15] = (1.0 * ((3.0 / (1.0 + exp(( -60.0 - ((0.001 * var_chaste_interface__Membrane__Vm) * 1000.0)) * 0.050000000000000003))) * (1.1200000000000001 / (1.0 + exp(( -60.0 + ((0.001 * var_chaste_interface__Membrane__Vm) * 1000.0)) * 0.050000000000000003))))) * 0.001;
            }
            
            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__Membrane__Vm = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][16] = 1.0 / (1.0 + exp((((-(0.001 * var_chaste_interface__Membrane__Vm)) * 1000.0) - 20.0) * 0.0625));
            }
            
            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__Membrane__Vm = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][17] = (1.0 * ((1100.0 / sqrt(1.0 + exp(( -10.0 - ((0.001 * var_chaste_interface__Membrane__Vm) * 1000.0)) * 0.16666666666666666))) * (1.0 / (1.0 + exp(( -60.0 + ((0.001 * var_chaste_interface__Membrane__Vm) * 1000.0)) * 0.050000000000000003))))) * 0.001;
            }
            
            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__Membrane__Vm = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][18] = 1.0 / (1.0 + exp((((0.001 * var_chaste_interface__Membrane__Vm) * 1000.0) + 77.849999999999994) * 0.20000000000000001));
            }
            
            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__Membrane__Vm = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][19] = (1900.0 / (1.0 + exp((((0.001 * var_chaste_interface__Membrane__Vm) * 1000.0) + 15.0) * 0.10000000000000001))) * 0.001;
            }
            
            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__Membrane__Vm = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][20] = 1.0 / (1.0 + exp((((0.001 * var_chaste_interface__Membrane__Vm) * 1000.0) + 53.0) * 0.076923076923076927));
            }
            
            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__Membrane__Vm = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][21] = (6.0599999999999996 + (39.101999999999997 / ((0.56999999999999995 * exp( -0.080000000000000002 * (((0.001 * var_chaste_interface__Membrane__Vm) * 1000.0) + 44.0))) + (0.065000000000000002 * exp(0.10000000000000001 * (((0.001 * var_chaste_interface__Membrane__Vm) * 1000.0) + 45.93)))))) * 0.001;
            }
            
            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__Membrane__Vm = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][22] = 1.0 / (1.0 + exp((-(((0.001 * var_chaste_interface__Membrane__Vm) * 1000.0) - 22.300000000000001)) * 0.053333333333333337));
            }
            
            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__Membrane__Vm = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][23] = (2.75352 + (14.40516 / ((1.0369999999999999 * exp(0.089999999999999997 * (((0.001 * var_chaste_interface__Membrane__Vm) * 1000.0) + 30.609999999999999))) + (0.36899999999999999 * exp( -0.12 * (((0.001 * var_chaste_interface__Membrane__Vm) * 1000.0) + 23.84)))))) * 0.001;
            }
...
private:
    ...
    static std::auto_ptr<Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLOpt_LookupTables> mpInstance;
...
std::auto_ptr<Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLOpt_LookupTables> Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLOpt_LookupTables::mpInstance;
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLOpt::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[15];
    }
    
    Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLOpt::Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLOpt(boost::shared_ptr<AbstractIvpOdeSolver> pSolver, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCardiacCell(
                pSolver,
                18,
                0,
                pIntracellularStimulus)
    {
        ...
        // 
        this->mpSystemInfo = OdeSystemInformation<Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLOpt>::Instance();
        Init();
    ...
    void Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__Membrane__Vm = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
        ...
        const bool _oob_0 = Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__Membrane__Vm);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY, var_chaste_interface__environment__time));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__Membrane__Vm);
        ...
        const double d_dt_chaste_interface__i_Na_m_gate__m = 0.001 * ((_lt_0_row[0] - var_chaste_interface__i_Na_m_gate__m) / _lt_0_row[1]); // 'per millisecond'
        const double d_dt_chaste_interface__i_Na_h_gate__h = 0.001 * ((_lt_0_row[2] - var_chaste_interface__i_Na_h_gate__h) / _lt_0_row[3]); // 'per millisecond'
        const double d_dt_chaste_interface__i_Na_j_gate__j = 0.001 * ((_lt_0_row[4] - var_chaste_interface__i_Na_j_gate__j) / _lt_0_row[5]); // 'per millisecond'
        const double d_dt_chaste_interface__i_CaL_d_gate__d = 0.001 * ((_lt_0_row[6] - var_chaste_interface__i_CaL_d_gate__d) / _lt_0_row[7]); // 'per millisecond'
        const double d_dt_chaste_interface__i_CaL_f1_gate__f1 = 0.001 * ((_lt_0_row[8] - var_chaste_interface__i_CaL_f1_gate__f1) / ((_lt_0_row[9] * (((_lt_0_row[10] - var_chaste_interface__i_CaL_f1_gate__f1) > 0.0) ? (1.0 + (1433.0 * (var_chaste_interface__calcium_dynamics__Cai - 4.9999999999999996e-05))) : 1.0)) * 0.001)); // 'per millisecond'
        const double d_dt_chaste_interface__i_CaL_f2_gate__f2 = 0.001 * ((_lt_0_row[11] - var_chaste_interface__i_CaL_f2_gate__f2) / _lt_0_row[12]); // 'per millisecond'
        ...
        const double d_dt_chaste_interface__i_Kr_Xr1_gate__Xr1 = 0.001 * (((1.0 / (1.0 + exp(((1000.0 * (((( -8.3144720000000003 * mParameters[17]) * 4.5062037604505159e-06) * log(pow(1.0 + (mParameters[1] * 0.38461538461538458), 4.0) / (0.025000000000000001 * pow(1.0 + (mParameters[1] * 1.7241379310344829), 4.0)))) - 0.019)) - ((0.001 * var_chaste_interface__Membrane__Vm) * 1000.0)) * 0.2040816326530612))) - var_chaste_interface__i_Kr_Xr1_gate__Xr1) / _lt_0_row[13]); // 'per millisecond'
        const double d_dt_chaste_interface__i_Kr_Xr2_gate__Xr2 = 0.001 * ((_lt_0_row[14] - var_chaste_interface__i_Kr_Xr2_gate__Xr2) / _lt_0_row[15]); // 'per millisecond'
        const double d_dt_chaste_interface__i_Ks_Xs_gate__Xs = 0.001 * ((_lt_0_row[16] - var_chaste_interface__i_Ks_Xs_gate__Xs) / _lt_0_row[17]); // 'per millisecond'
        const double d_dt_chaste_interface__i_f_Xf_gate__Xf = 0.001 * ((_lt_0_row[18] - var_chaste_interface__i_f_Xf_gate__Xf) / _lt_0_row[19]); // 'per millisecond'
        const double d_dt_chaste_interface__i_to_q_gate__q = 0.001 * ((_lt_0_row[20] - var_chaste_interface__i_to_q_gate__q) / _lt_0_row[21]); // 'per millisecond'
        const double d_dt_chaste_interface__i_to_r_gate__r = 0.001 * ((_lt_0_row[22] - var_chaste_interface__i_to_r_gate__r) / _lt_0_row[23]); // 'per millisecond'
    ...
    std::vector<double> Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__Membrane__Vm = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLOpt>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLOpt)
